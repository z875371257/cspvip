...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    wx.request({
      url: 'https://vip.chplaza.com.cn/api/ProductShow?id=' + options.id,
  ...
  formSubmit: function (res) {
    ...
    var formid = res.detail.formId  //formid 模板推送需要
        ...
        if (res.code) {
          wx.request({
            ...
            success: function (data) {
              ...
              that.Pay(truename, tel, address, remark, pnum, price, pid, totalprice, data.data, formid)
            }
          })
        }
      }
  ...
  Pay: function (truename, tel, address, remark, pnum, price, pid, totalprice, openid, formid){
    var that = this
      ...
      success: function (res) {
        ...
        wx.requestPayment({
          ...
          'success': function (ress) { 
            ...
            that.PayOrder(truename, tel, address, remark, pnum, price, pid, totalprice, openid, 0, formid)
            that.setData({
              hints: false,
  ...
  // 将数据存入服务器数据库中
  PayOrder: function (  truename, tel, address, remark, pnum, price, pid, totalprice, openid, status, formid) {
